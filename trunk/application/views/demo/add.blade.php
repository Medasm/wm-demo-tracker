...
<form name="form" novalidate="novalidate">
    <div class="row">
        <div class="span4">
            ...
            <input type="text" ng-model="studentName" name="studentName" ng-required="true" id="name" placeholder="Enter full name"
                   class="span4">
        </div>
        <div class="span4"><label for="name">Mobile</label>
            <input name="mobile" type="text" ng-model="mobile" ng-required="true" ng-minLength="8" id="mobile" class="span4">
            <span ng-show="form.mobile.$invalid && !form.mobile.$pristine" class="text-error">The mobile number should be at least 8 digits </span>
        </div>
        <div class="span4">
    ...
    <div class="row">
        <div class="span4">
            <button type="button" ng-disabled="form.$invalid" ng-click="addDemo()" class="btn btn-success">Add Demo</button>
        </div>
    </div>
</form>
